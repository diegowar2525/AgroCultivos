...
export const NIVELES = [
    ...
    { nivel: 2, nombre: 'Agricultor', min: 1, max: 2, icon: Leaf, color: '#6fc844', desc: 'Ya tienes tu primera cosecha completada.' },
...
export function calcularInsignias(cultivos) {
    ...
    return [
        { id: 'primera', nombre: 'Primera Cosecha', desc: 'Completa tu primer cultivo', icon: CheckCircle, color: '#6fc844', desbloqueada: completados >= 1, progreso: Math.min(completados, 1), meta: 1 },
