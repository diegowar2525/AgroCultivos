...
export default function ProfileDetails({
    ...
    const generoLabel =
        GENERO_LABELS[user.genero] || user.genero || '—';

    function solicitarEliminacionCuenta() {
        toast.info(
            ({ closeToast }) => (
                <ConfirmationToast
                    closeToast={closeToast}
                    onConfirm={onEliminarCuenta}
        ...
        <div className="profile-main">
            ...
            <div className="profile-card profile-card--danger">
                ...
                <div className="profile-danger-row">
                    <div>
                        <div className="profile-danger-label">
                            Eliminar mi cuenta
                        </div>

                        <div className="profile-danger-hint">
